...
from apps.user.utils import decode_uuid_from_base64, encode_uuid_to_base64
...
def get_user_for_password_reset_token(token):
    ...
    try:
        ...
        raise ValidationError(default_error_messages["invalid_token"])
    ...
    if not user:
        raise ValidationError(default_error_messages["user_not_found"])
